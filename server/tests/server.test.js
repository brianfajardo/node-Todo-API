...
describe('GET /todos/:id', () => {
    ...
    it('should not return a todo doc created by other user', (done) => {
        request(app)
            .get(`/todos/${todos[1]._id.toHexString()}`) /* template string to insert id of first todo and convert to String type */
            .set('x-auth', users[0].tokens[0].token)
            .expect(404)
            .end(done);
    });
...
describe('DELETE /todos/:id', () => {
    ...
    it('should not remove a todo by id if the user is not the creator', (done) => {
